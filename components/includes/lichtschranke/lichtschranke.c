...
{
	gpio_num_t gpio_num_ir=(gpio_num_t) arg;
	// Interrupt kurzzeitig deaktivieren
	gpio_isr_handler_remove(gpio_num_ir);
	// 10ms warten
	vTaskDelay(10 / portTICK_RATE_MS);
	//interrupt wieder aktivieren
	gpio_isr_handler_add(gpio_num_ir, gpio_isr_handler, (void*) gpio_num_ir);
